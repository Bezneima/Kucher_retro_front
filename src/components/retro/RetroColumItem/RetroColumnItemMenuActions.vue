<template>
  ...
  <button class="retro-item-menu-button" type="button" @click="onCopyTextClick">
...
const onDeleteCardClick = () => emit('deleteCard')
</script>
